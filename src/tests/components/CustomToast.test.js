...
describe("Fade out", () => {
  ...
  test("should call onClose after 4 seconds", () => {
    render(
      <CustomToast type="success" message="Will close" onClose={mockOnClose} />
    );
...
describe("Close on click", () => {
  test("should call onClose when clicked on", () => {
    render(
      <CustomToast type="success" message="Will close" onClose={mockOnClose} />
    );

    const toast = screen.getByText("Will close");
...
describe("Display messages", () => {
  test("should display an error message", () => {
    render(
      <CustomToast type="error" message="Error message" onClose={mockOnClose} />
    );
